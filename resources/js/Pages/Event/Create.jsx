    ...
    return (
        <div className='flex'>
            ...
            <div className='bg-blue-50 w-full'>
                ...
                <div className='mx-8 my-2 bg-white mt-6 rounded-t-2xl'>
                    <div>
                    ...
                    <form className=''>
                        ...
                        <div className='flex flex w-full w-full justify-between px-6 p-2 items-center'>
                        ...
                        <div className='flex w-full justify-between px-6 p-2 items-center'>
                            <label>Thumbnail</label>
                            <div className='max-w-4xl float-start max-w-md w-full'>
                            <input
