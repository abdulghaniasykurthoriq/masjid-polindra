...
const FormPemasukan = (props) => {
    ...
    const [inputs, setInputs] = useState([
        { id: 1, jumlah_pemasukan: 0, kategory: 'infaq', keterangan: '' },
    ]);

    const handleInputChange = (index, value) => {
        console.log('input.value', inputs);
        const updatedInputs = [...inputs];
        updatedInputs[index].jumlah_pemasukan = parseInt(value);
    ...
    const handleSubmit = (event) => {
        ...
        const url = route('kas.storePemasukan', {
